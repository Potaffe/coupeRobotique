...
//CreateDelaiMs :
//Débute une temporisation en ms sans attendre la fin.
//Renvoie un entier à utiliser lors de l'appel de FinDelaiMs()
//Terminer la session obligatoirement avec CloseDelaiMs
int CreateDelaiMs(uint16_t ms);

//FinDelaiMs :
//Renvoie 1 si la temporisation 'n' est terminée ou est incorrecte
...
//CloseDelaiMs :
// Arrête la temporisation 'n' et termine la session ouverte avec CloseDelaiMs
void CloseDelaiMs(int n);
